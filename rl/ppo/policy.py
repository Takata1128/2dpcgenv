...
class Policy(nn.Module):
    def __init__(
        self, obs_shape, action_space, base=None, base_kwargs=None, activation=None, model="base"
    ):
    ...
    def act(self, inputs, rnn_hxs, masks, deterministic=False):
        ...
        if self.activation == 'sigmoid':
            ...
            raise NotImplementedError(
                f"{self.activation} activation function is not implemented!")
...
class CNNBase(NNBase):
    def __init__(
        ...
        self.main = nn.Sequential(
            nn.Conv2d(num_inputs, 128, 3, padding=(1, 1), stride=1),
            nn.BatchNorm2d(128),
            nn.ReLU(),
            ...
            Flatten(),
            nn.Dropout(dropout),
            nn.Linear(32 * 16 * 32, hidden_size),
            nn.ReLU(),
        )
